:construction_worker: Employed to facilitate genomics research 🧬 Previously helping to distribute [public GNSS data for the Danish government](https://dataforsyningen.dk/data?filter=&view=gallery&search=gnss).
